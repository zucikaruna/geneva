...
public class RefData {
	  ...
	  private String cme_group;
		 @Column
	  private Double cme_depth;
		 @Column
	  private Double cme_impl_depth;
		 @Column
	  private Double cme_df;
		 @Column
	  private Double cme_md;
		 @Column
	  ...
	  private String cqg_implied_depth;
		 @Column
	  private Double cqg_df;
		 @Column
	  private Double order_increment_qty;
		 @Column
	...
	public Double getCme_depth() {
		return cme_depth;
	}
	public void setCme_depth(Double cme_depth) {
		this.cme_depth = cme_depth;
	}
	public Double getCme_impl_depth() {
		return cme_impl_depth;
	}
	public void setCme_impl_depth(Double cme_impl_depth) {
	...
	public Double getCme_md() {
		return cme_md;
	}
	public void setCme_md(Double cme_md) {
		this.cme_md = cme_md;
	}
	...
	public Double getCqg_df() {
		return cqg_df;
	}
	public void setCqg_df(Double cqg_df) {
		this.cqg_df = cqg_df;
	}
	public Double getOrder_increment_qty() {
		return order_increment_qty;
	}
	public void setOrder_increment_qty(Double order_increment_qty) {
